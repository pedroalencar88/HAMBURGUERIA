object FRMCLIENTE: TFRMCLIENTE
  ...
  object QINSERECLIENTE: TFDQuery
    Connection = DM_.FDCONEXAO
    SQL.Strings = (
      'INSERT INTO CLIENTE '
      '(NOME,CPF,CEP,ENDERECO,EMAIL,CELULAR,SENHA,TIPO) VALUES'
      '(:NOME,:CPF,:CEP,:ENDERECO,:EMAIL,:CELULAR,:SENHA,:TIPO)')
    Left = 264
    Top = 192
    ParamData = <
      item
  ...
  object QVALIDACPF: TFDQuery
    ...
    object QVALIDACPFCODIGO: TFDAutoIncField
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    end
    object QVALIDACPFNOME: TStringField
      FieldName = 'NOME'
      Origin = 'NOME'
      Size = 50
    end
    object QVALIDACPFCPF: TStringField
      FieldName = 'CPF'
      Origin = 'CPF'
      Size = 14
    end
    object QVALIDACPFCEP: TWideStringField
      FieldName = 'CEP'
      Origin = 'CEP'
      FixedChar = True
      Size = 10
    end
    object QVALIDACPFENDERECO: TWideStringField
      FieldName = 'ENDERECO'
      Origin = 'ENDERECO'
      FixedChar = True
      Size = 40
    end
    object QVALIDACPFEMAIL: TWideStringField
      FieldName = 'EMAIL'
      Origin = 'EMAIL'
      FixedChar = True
      Size = 40
    end
    object QVALIDACPFCELULAR: TWideStringField
      FieldName = 'CELULAR'
      Origin = 'CELULAR'
      FixedChar = True
      Size = 14
    end
    object QVALIDACPFSENHA: TWideStringField
      FieldName = 'SENHA'
      Origin = 'SENHA'
      FixedChar = True
      Size = 10
